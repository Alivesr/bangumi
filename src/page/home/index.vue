...
import { AppstoreOutlined, BarsOutlined } from "@vicons/antd";
import { List20Filled } from "@vicons/fluent";
...
<template>
  ...
  >
    ...
    <!-- grid布局：一行7列，每列一天 -->
    <div v-if="layout === 'grid'" class="grid grid-cols-1 md:grid-cols-7 gap-6">
      <div
    ...
    <div v-else class="flex flex-col items-start justify-start gap-8">
      <div
